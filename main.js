document.addEventListener('DOMContentLoaded', () => {
  ...
  function configurarAccesoCodigo() {
    ...
    const codigosInvitacion = {
      ...
      "FAM-RANGEL01": { invitados: ["Adulto 1", "Adulto 2"], mensaje: "¡Hola Madrina! Llego el momento que tanto esperamos, me encantará contar con su compañía siempre, pero en especial este 25 de Octubre. Tienen 2 lugares reservados. Un beso y un abrazo." },
      ...
      "FAM-ALBARRAN01": { invitados: ["Adulto 1", "Adulto 2", "Adulto 3", "Adulto 4", "Adulto 5"], mensaje: "¡Gustavo Albarran! Me encantará contar con su compañía. Tienen 5 lugares reservados para su familia. ¡Nos vemos el 25 de octubre!" },
      "FAM-ALBARRAN02": { invitados: ["Adulto 1", "Adulto 2"], mensaje: "¡Cesar Albarran! Me encantará contar con su compañía. Tienen 2 lugares reservados para su familia. ¡Nos vemos el 25 de octubre!" },
      ...
      "FAM-RANGEL04": { invitados: ["Adulto 1", "Adulto 2", "Niñ@"], mensaje: "¡Rodrigo Rangel! Me emocionará compartir este día con ustedes. Reservé 3 lugares: 2 adultos y 1 niño. Gracias por ser parte de mi historia." },
      "FAM-RANGEL05": { invitados: ["Adulto 1", "Adulto 2"], mensaje: "¡José Antonio Rangel! Me encantará contar con su compañía. Tienen 2 lugares reservados para su familia. ¡Nos vemos el 25 de octubre!" },
